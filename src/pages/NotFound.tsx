  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-[520px] mx-auto">
        ...
        <div
          className="text-[7rem] xs:text-[9rem] font-extrabold leading-none mb-4 select-none"
          style={{
        ...
        <div className="mt-10 pt-7 border-t border-border">
          <p className="text-[0.8rem] font-semibold uppercase tracking-[0.08em] text-muted mb-4">
            Páginas disponíveis
          </p>
